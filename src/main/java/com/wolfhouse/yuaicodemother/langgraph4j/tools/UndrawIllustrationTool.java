package com.wolfhouse.yuaicodemother.langgraph4j.tools;
...
import com.wolfhouse.yuaicodemother.langgraph4j.model.enums.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    ...
    private static final String UNDRAW_API_URL = "https://undraw.co/_next/data/9fXhtueLm0tySnSMDaVOx/search/%s" +
                                                 ".json?term=%s";
