...
import com.wolfhouse.yuaicodemother.langgraph4j.ai.ImageCollectionPlanService;
import com.wolfhouse.yuaicodemother.langgraph4j.model.ImageCollectionPlan;
...
import com.wolfhouse.yuaicodemother.langgraph4j.tools.ImageSearchTool;
import com.wolfhouse.yuaicodemother.langgraph4j.tools.LogoGeneratorTool;
import com.wolfhouse.yuaicodemother.langgraph4j.tools.MermaidDiagramTool;
import com.wolfhouse.yuaicodemother.langgraph4j.tools.UndrawIllustrationTool;
            ...
            try {
                ...
                if (plan.getDiagramTasks() != null) {
                    ...
                    for (ImageCollectionPlan.DiagramTask task : plan.getDiagramTasks()) {
                        futures.add(CompletableFuture.supplyAsync(() ->
                                                                      diagramTool.generateMermaidDiagram(task.mermaidCode(),
                                                                                                         task.description())));
                    }
                }
                // 并发执行Logo生成
